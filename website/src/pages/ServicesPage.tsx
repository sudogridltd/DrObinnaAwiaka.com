...
const FALLBACK_SERVICES = [
  { icon: Users, title: "1-on-1 Life Coaching", image: IMAGES.services.lifeCoaching, price: "From ₦247,500/session", description: "Deep, personalized coaching sessions designed to help you gain clarity, overcome limiting beliefs, and create a roadmap for the life you want.", features: ["60-minute sessions (virtual or in-person)", "Personalized goal-setting framework", "Between-session accountability", "Access to exclusive resources", "Email support between sessions"] },
  { icon: Briefcase, title: "Executive & Leadership Coaching", image: IMAGES.services.executive, price: "From ₦495,000/session", description: "Elevate your leadership presence, strategic thinking, and team performance with coaching designed for C-suite executives and rising leaders.", features: ["90-minute deep-dive sessions", "360-degree leadership assessment", "Stakeholder interview & analysis", "Custom leadership development plan", "Priority scheduling & support"] },
  { icon: GraduationCap, title: "Group Coaching Programs", image: IMAGES.services.group, price: "From ₦123,750/person/session", description: "Small-group experiences (6-12 people) that foster accountability, shared learning, and collective breakthroughs through structured modules.", features: ["12-week structured program", "Weekly 90-minute group sessions", "Private community access", "Peer accountability partners", "Program workbook included"] },
  { icon: Heart, title: "Relationship & Couples Coaching", image: IMAGES.services.couples, price: "From ₦330,000/session", description: "Strengthen your relationships with coaching that addresses communication, conflict resolution, intimacy, and shared life vision.", features: ["75-minute couple sessions", "Communication style assessment", "Conflict resolution frameworks", "Shared vision planning", "Individual follow-up sessions"] },
  ...
  { icon: BookOpen, title: "Online Courses & Resources", image: IMAGES.services.courses, price: "From ₦47,850", description: "Self-paced digital courses, workbooks, and guided programs for those who want to start their transformation journey on their own schedule.", features: ["Video-based learning modules", "Downloadable workbooks & tools", "Lifetime access to content", "Community forum access", "Certificate of completion"] },
];
